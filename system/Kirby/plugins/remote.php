...
class remote {
	...
	public static function get($url, $data=array(), $format=false, $options=array()) {
	...
	public static function post($url, $data=array(), $format=false, $options=array()) {
	...
	public static function request($url, $post=false, $options=array()) {
	...
	public static function parse($result, $format='plain') {
	...
	public static function agent($id=false) {
